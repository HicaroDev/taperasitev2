...
export const Component = ({
  ...
  return (
    <div
            ...
            {items.map((item, index) => (
              <li
                ...
                <div className="flex items-start gap-6">
                  ...
                  <span
                    className={cn(
                      ...
                      activeIndex === index
                        ...
                        : "text-zinc-600 group-hover:text-brand-red/60"
                    )}>
                    {item.num}
                  </span>
                  ...
                  <h2
                    className={cn(
                      "text-5xl md:text-6xl font-black uppercase tracking-tighter leading-[0.85] transition-all duration-700 [text-stroke:1px_black] [-webkit-text-stroke:1px_black]",
                      activeIndex === index
                        ? "text-brand-red opacity-100 translate-x-4"
                        : "opacity-40 translate-x-0 text-zinc-500 group-hover:text-brand-red group-hover:opacity-100"
                    )}>
      ...
      <div
        className="relative w-full md:w-1/2 flex justify-center items-center mt-16 md:mt-0">
        <div
          className="absolute w-[120%] h-[120%] bg-orange-500/10 dark:bg-orange-600/5 blur-[120px] rounded-full transition-opacity duration-1000" />
